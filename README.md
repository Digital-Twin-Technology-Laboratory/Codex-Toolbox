...
- 弹窗默认显示数据源提供的 24 小时制详细时间，可在设置中切换为 AM/PM 简洁日期。
...
```bash
shasum -a 256 -c Show-Codex-IQ-0.1.0-beta.6.2-universal.dmg.sha256
```
...
bash scripts/verify_dmg.sh dist/Show-Codex-IQ-0.1.0-beta.6.2-universal.dmg
```
